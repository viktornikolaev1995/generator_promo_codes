...
class TestGeneratorPromoCodes(TestCase):
    ...
    def test_generator_promo_codes(self):
        ...
        inserting_data_in_jsonfile(group_name='avtostop', amount='42')
        inserting_data_in_jsonfile(group_name='1', amount='5')
        inserting_data_in_jsonfile(group_name='1', amount='1')
